...
class TableauPile extends PositionComponent implements Pile {
  TableauPile({super.position}) : super(size: BlackjackGame.cardSize);

  /// Which cards are currently placed onto this pile.
  final List<Card> _cards = [];
  final Vector2 _fanOffset1 = Vector2(0, BlackjackGame.cardHeight * 0.05);
  final Vector2 _fanOffset2 = Vector2(0, BlackjackGame.cardHeight * 0.20);
